  ...
  var QuickSettings = {
      ...
      this._controls[title] = {
        ...
        setValue: function (value) {
          ...
          this.label.innerHTML =
            '<b>' + this.title + ':</b> ' + this.control.value;
          if (callback) {
            callback(value);
          }
        },
    ...
    addProgressBar: function (title, max, value, valueDisplay) {
      ...
      if (valueDisplay === 'numbers') {
        ...
        label.innerHTML =
          '<b>' + title + ':</b> ' + Math.round((value / max) * 100) + '%';
      } else {
      ...
      this._controls[title] = {
        ...
        setValue: function (value) {
          ...
          if (this.valueDisplay === 'numbers') {
            this.label.innerHTML =
              '<b>' + this.title + ':</b> ' + this.value + ' / ' + this.max;
    ...
    setProgressMax: function (title, max) {
      ...
      if (control.valueDisplay === 'numbers') {
        ...
        control.label.innerHTML =
          ...
          control.title +
          ':</b> ' +
          Math.round((control.value / control.max) * 100) +
          '%';
      } else {
